// 4-letter wordle game - basically guess the word but make it hard
...
const WORD_LENGTH = 4; // 3, 4, 5, 6, or 7
...
export default function Wordle4() { // rename to Wordle3, Wordle4, etc.
  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      ...
      <Card className="max-w-xl mx-auto p-4">
        <h1 className="text-2xl font-bold mb-2">4-Letter Wordle</h1>

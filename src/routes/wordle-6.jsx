// 6-letter wordle game - basically guess the word but make it hard
...
const WORD_LENGTH = 6; // 3, 4, 5, 6, or 7
...
export default function Wordle6() { // rename to Wordle3, Wordle4, etc.
